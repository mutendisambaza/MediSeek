...
public class directory {
    ...
    public String toString() {
        String tmp = addSpace(15, sName+"")+addSpace(10,sSurname)+addSpace(15,gender)+addSpace(20,jobDescription)+addSpace(20,residence)+addSpace(20,qualifications)+addSpace(30,contact)+addSpace(40,staff_ID);
        return tmp;
    }
